...
app.listen(port, () => {
  console.log(gradient.rainbow(`[ SERVER ] localhost:${port} https://${process.env.REPL_ID}.pike.replit.dev/`));
        ...
        var listenEmitter = api.listenMqtt(async (error, event) => {
          ...
          .then(response => {
              ...
              return api.sendMessage("𝗖𝗢𝗡𝗡𝗘𝗖𝗧𝗜𝗡𝗚...", event.threadID, () => 
                  api.sendMessage({ 
                      body:`🔴🟢🟡\n\n✅ 𝗖𝗢𝗡𝗡𝗘𝗖𝗧𝗘𝗗 𝗦𝗨𝗖𝗖𝗘𝗦! \n\n➭ 𝗕𝗼𝘁𝗡𝗮𝗺𝗲: ${botName}\n➭ 𝗕𝗼𝘁 𝗣𝗿𝗲𝗳𝗶𝘅: ‹${prefix}›\n➭ 𝗔𝗱𝗺𝗶𝗻: ‹${adminName}›\n➭ 𝗢𝘄𝗻𝗲𝗿𝗟𝗶𝗻𝗸: ‹https://m.facebook.com/${admin}›\n➭ 𝗨𝘀𝗲 ${prefix}help to view command details\n➭ Added bot at: ⟨ ${time} ⟩〈 ${thu} 〉`, 
...
const { botName, adminName } = require('./script/info.js');
